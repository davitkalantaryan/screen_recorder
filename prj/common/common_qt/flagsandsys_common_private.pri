...
isEmpty(screenRecorderPrivateFlagsAndSysCommonIncluded){
    screenRecorderPrivateFlagsAndSysCommonIncluded = 1

    include("$${PWD}/flagsandsys_common.pri")

    INCLUDEPATH += $${screenRecorderRepositoryRoot}/src/include
}
